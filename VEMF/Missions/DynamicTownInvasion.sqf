...
_msgArray = ["Come on they have small dicks you can take them!","I heard they are a bunch of retards go knock them out","If you kill them you'll get a cookie","Free Hello Kitty stickers in the loot crate yaaaay","Sorry mega mindy is offline you will have to do this one mate","Sorry superman is asleep. You are on your own....","Save the poor hostage teddy bears!","They want attention! Go pay them a visit","They forgot their breakfast. They eat .50s...","They have nothing too loose. Except their action figures.","Go teach them sum ballistics!","Make them see the light. Of your flashlight if you have one.","Time to send them to AI heaven. Or hell I dont know...","Give them a chance to see the debug box from the inside LOL"];
...
_msg = ["Yaay someone found the Hello Kitty stickers!","Hooraay the teddy bears are saved :D","Yep, they are all sleeping now....","To the debug box! All of them!","They ran away lol","They all started crying!","Something to do with a white flag...","They gave up and started dancing","They had whiskey. Now it is our whiskey.","They got YOLO'd."];
